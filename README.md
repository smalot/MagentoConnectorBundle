...
Install the MagentoConnector with composer:
    ...
    $ php composer.phar require akeneo/magento-connector-bundle:1.0.*@stable akeneo/delta-export-bundle:v1.0.0-BETA2 akeneo/connector-mapping-bundle:v1.0.0-BETA3
